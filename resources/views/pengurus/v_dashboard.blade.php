                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <h5 style="margin-top: -10px">124 Santri Aktif</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                ...
                                <h5 style="margin-top: -10px">124 Data Pembayaran</h5>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <h5 style="margin-top: -10px">124 Hafalan</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <h5 style="margin-top: -10px">12 Content</h5>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-body text-center">
                    <p class="card-header" style="margin-bottom: 20px;">Menu Pengurus</p>
                    ...
                    <div class="col mb-3" style="margin-right: 5px">
                      ...
                      <div class="col mb-3 text-center" style="margin-right: 5px">
                        ...
                        <p class="text-secondary"><small>Kelola Pengumuman</small></p>
                      </div>
                      <div class="col mb-3" style="margin-right: 5px">
                        <a href="/data-content" class="mb-1 bg-gradient-primary  text-white text-center" >
                            <span><img src="{{ asset('NiceAdmin/') }}/assets/img/content.png" alt="" width="50"></span>
                        </a>
                        <p class="text-secondary"><small>Kelola Konten</small></p>
