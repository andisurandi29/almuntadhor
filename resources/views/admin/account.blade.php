                    ...
                    <div class="card-body">
                      <form action="{{ route('update-foto', $user->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                          <img src="{{ URL::to('/')}}/foto/{{ $upload->foto }}" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar"/>
                          <input type="hidden" class="form-control-file mt-3" name="old_image" value="{{ $upload->foto }}">
